...
def main():
    ...
    model_path = "logs/best_model_mtf/best_model.zip"
    ...
    env = CryptoMtfEnv(val_df, feature_cols, lookback_window=10, fee_pct=0.001)
    ...
    print("Evaluating model on MTF validation environment...")
    done = False
    ...
    print("\n" + "="*40)
    print("BENCHMARK METRICS (Phase 3 - MTF)")
    print("="*40)
    ...
    plt.savefig("logs/plots/evaluation_mtf_results.png")
    print("\nEvaluation plot saved to logs/plots/evaluation_mtf_results.png")
